      ...
      <TR>
        ...
        <TD>
          <DL>
            ...
            <DD>区域:${h.dname},街道:${h.sname},类型:${h.tname},面积:${h.floorage}平米,<BR>联系方式:${h.contact} </DD></DL></TD>
        <TD class=house-type>
        ...
        <TD class=house-price><LABEL class=ui-green><INPUT value="删    除" onclick="delHouse(this,${h.id})" id="delButton2" type=button  >
          <input type="hidden" value="${h.id}"></LABEL></TD>
      </TR>
      </c:forEach>
