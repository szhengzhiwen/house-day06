...
<div id="tb">
    ...
    <a href="javascript:DeleteMoreType()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">批量删除</a>
</div>

<%--制作添加对话框--%>
<div id="AddDialog" class="easyui-dialog" title="类型添加" buttons="#AddDialogButtons"
     style="width: 280px; height: 250px; padding: 10px 20px;" closed="true">
    <form action="" name="addForm" id="addForm" method="post">
        类型名称:<input type="text" id="name" name="name"><br/>
...
<%--制作修改对话框--%>
<div id="upDialog" class="easyui-dialog" title="类型修改" buttons="#upDialogButtons"
     style="width: 280px; height: 250px; padding: 10px 20px;" closed="true">
    <form action="" name="upForm" id="upForm" method="post">
        类型名称:<input type="text" id="name2" name="name"><br/>
